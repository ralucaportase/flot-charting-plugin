describe('A HistoryBufferNumeric', function () {
    ...
    var oneLevelTreeLength = HistoryBufferNumeric.prototype.getDefaultBranchingFactor();
    var twoLevelsTreeLength = oneLevelTreeLength * HistoryBufferNumeric.prototype.getDefaultBranchingFactor();
    var threeLevelsTreeLength = twoLevelsTreeLength * HistoryBufferNumeric.prototype.getDefaultBranchingFactor();
    ...
    it('has a width property', function () {
        var hb = new HistoryBufferNumeric(10, 3);

        expect(hb.width).toBe(3);
    });

    it('has a setWidth method', function () {
        var hb = new HistoryBufferNumeric(10, 1);
    ...
    it('appendArray method works with arrays bigger that the hb capacity', function () {
        var hb = new HistoryBufferNumeric(3);
    ...
    describe('A segment tree', function () {
        ...
        it('has multiple segment trees for muliple data series', function () {
            var hb = new HistoryBufferNumeric(128, 2);
        ...
        describe('One level deep', function () {
            ...
            it('computes the max and min correctly for 64 elements', function () {
                var hb = new HistoryBufferNumeric(64 * 2); //half full history buffer
